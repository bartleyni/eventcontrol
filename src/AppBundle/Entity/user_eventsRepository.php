...
class user_eventsRepository extends EntityRepository
{
    ...
    public function getActiveEventEndTime($userId)
    {
        ...
        return $this->getEntityManager()->createQuery('SELECT event.event_log_stop_date FROM AppBundle\Entity\event event WHERE event.event_id = :id')->setParameter('id', $user_event)->getOneOrNullResult();
