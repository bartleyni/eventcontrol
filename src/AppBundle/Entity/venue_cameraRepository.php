...
class venue_cameraRepository extends EntityRepository
{
    ...
    {
        return $this->getEntityManager()->createQuery('SELECT IDENTITY(p.camera_id) as camera_id, p.inverse FROM AppBundle\Entity\venue_camera p  WHERE p.venue_id = :id')->setParameter('id', $id)->getResult();
    }
