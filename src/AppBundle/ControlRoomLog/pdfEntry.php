...
class pdfEntry extends Controller
{
    ...
    */
    ...
    {  
        ...
        if($event)
        {
            $iframe = '<iframe src="https://eventcontrol.nb221.com/PDFview/'.$event->getId().'" frameborder=0 scrolling=no height="900px" class="col-md-12 embed-responsive-item" ></iframe>';
